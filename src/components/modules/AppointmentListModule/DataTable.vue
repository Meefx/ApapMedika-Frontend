  ...
  <div>
    <div class="flex items-center py-4">
      ...
      <Input
        ...
        :model-value="table.getColumn('doctorName')?.getFilterValue() as string"
        @update:model-value="table.getColumn('doctorName')?.setFilterValue($event)"
      />
      ...
      <!-- <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          <DropdownMenuCheckboxItem
            v-for="status in ['Created', 'Done', 'Cancelled']"
            :key="status"
            :model-value="table.getColumn('status')?.getFilterValue() as string"
            @update:model-value="table.getColumn('status')?.setFilterValue($event)"
          >
